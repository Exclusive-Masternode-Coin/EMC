    ...
    ui(new Ui::AddEditAdrenalineNode)
{
    ...
    ui->txhashLineEdit->setPlaceholderText("Enter your 5000 EMC TXID");
    ui->outputindexLineEdit->setPlaceholderText("Enter your transaction output index");
    ui->donationaddressLineEdit->setPlaceholderText("Enter aEMCaddress for your MN donation");
...
void AddEditAdrenalineNode::on_okButton_clicked()
{
    ...
    {
        QMessageBox msg;
        msg.setText("Please enter an ip address and port. (123.45.67.89:31507)");
        msg.exec();
        return;
    }
