...
public:
    ...
    void retranslateUi(QDialog *DarksendConfig)
    {
        ...
        label_2->setText(QApplication::translate("DarksendConfig", "Use 2 separate masternodes to mix funds up to 1000 EMC", 0));
        label_3->setText(QApplication::translate("DarksendConfig", "Use 8 separate masternodes to mix funds up to 1000 EMC", 0));
        label_4->setText(QApplication::translate("DarksendConfig", "Use 16 separate masternodes", 0));
        label_6->setText(QApplication::translate("DarksendConfig", "This option is the quickest and will cost about ~0.025EMCto anonymize 1000 EMC", 0));
        label_7->setText(QApplication::translate("DarksendConfig", "This option is moderately fast and will cost about 0.05EMCto anonymize 1000 EMC", 0));
        ...
        label_9->setText(QApplication::translate("DarksendConfig", "0.1 EMC per 1000 EMC you anonymize.", 0));
    } // retranslateUi
